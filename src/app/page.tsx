    ...
    <>
      ...
      <section className="hero">
        <div className="hero-inner">
          <div>
            <div className="hero-badge">// agente de IA para WhatsApp</div>
            <h1>Nunca mais perca um lead por demora no atendimento.</h1>
            <p className="hero-sub">
              Agentes de IA que atendem, qualificam e vendem pelo WhatsApp — sem você precisar
              estar online. Configurado em até 7 dias úteis, rodando 24/7.
            </p>
            ...
            <div className="hero-stats">
              <div className="stat">
                ...
                <div className="stat-label">Para ativar</div>
              </div>
              <div className="stat">
      ...
      <section id="como-funciona" style={{ padding: '100px 40px' }}>
        <div className="container">
          ...
          <h2 className="section-title">Do zero ao agente ativo em 7 dias úteis</h2>
          <p className="section-sub">
            Sem precisar saber programar. Nós cuidamos de tudo — você só aprova cada etapa.
          </p>
          <div className="steps-grid">
            <div className="step-card">
              <div className="step-num">DIA 01</div>
              <div className="step-icon">📋</div>
              <div className="step-title">Briefing</div>
              <div className="step-desc">
                Você nos conta sobre seu negócio, produtos, tom de voz, perguntas frequentes e
                principais objeções.
              </div>
            </div>
            <div className="step-card">
              ...
              <div className="step-desc">
                Montamos e treinamos seu agente com toda a base de conhecimento do seu negócio.
              </div>
            </div>
            <div className="step-card">
              <div className="step-num">DIA 04-05</div>
              <div className="step-icon">🧪</div>
              <div className="step-title">Testes</div>
              <div className="step-desc">
                Você conversa diretamente com o agente. Ajustamos o que não estiver perfeito até
                você aprovar.
              </div>
            </div>
            <div className="step-card">
              ...
              <div className="step-desc">
                Conectamos ao seu WhatsApp e ativamos com você acompanhando. Suporte contínuo após
                o lançamento.
              </div>
            </div>
          </div>
      ...
      <section style={{ padding: '100px 40px', background: 'var(--surface)' }}>
        <div className="container">
          ...
          <h2 className="section-title">
            Tudo que seu atendimento<br />precisa para converter.
          </h2>
          <div className="features-grid">
            {[
              { icon: '🕐', title: 'Atendimento 24/7', desc: 'Responde instantaneamente a qualquer hora, mesmo nos fins de semana e feriados. Nenhum lead fica sem resposta.' },
              { icon: '🎯', title: 'Qualificação automática', desc: 'Identifica leads quentes, coleta informações essenciais e prioriza quem está pronto para comprar.' },
              { icon: '📅', title: 'Agendamento direto', desc: 'Agenda consultas, reuniões e visitas direto pelo WhatsApp, sem precisar de intervenção humana.' },
              { icon: '🔗', title: 'WhatsApp nativo', desc: 'Opera no WhatsApp que seus clientes já usam. Sem apps novos, sem fricção, sem aprendizado.' },
              { icon: '📊', title: 'Dashboard de conversas', desc: 'Acompanhe todas as conversas, métricas de atendimento e leads gerados em tempo real.' },
              { icon: '✏️', title: 'Atualização simples', desc: 'Mudou preço, produto ou oferta? Atualize o agente em minutos com texto simples, sem programação.' },
            ].map(({ icon, title, desc }) => (
      ...
      <section id="contato" className="cta-final">
        <div className="container" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <h2>
            Configure hoje. Em até 7 dias úteis<br />seu agente está no ar.
          </h2>
          <p>
            Preencha abaixo e nossa equipe entra em contato pelo WhatsApp para agendar sua
